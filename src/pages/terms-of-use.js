...
const DownloadPage = () => (
  <Layout>
    ...
    Welcome, and thank you for your interest in Snowledge Corporation (“Snowledge”, “We,” or “Us”) and our Web site at www.snowledge.co (the “Site”), as well as all related web sites, networks, applications, and other services provided by us and on which a link to this Privacy Policy (this “Policy”) is displayed (collectively, together with the Site, our “Service”).
...
This Policy is incorporated into and is subject to the Snowledge Terms of Use (available at snowledge.co/terms). Capitalized terms used but not defined in this Policy have the meaning given to them in the Snowledge Terms of Use.

The information we collect on the Service:

User-provided Personal Data. When you use the Service, you may provide and we may collect what is generally called personally identifiable information, or personal information, which is information that specifically identifies an individual. For the purposes of this Privacy Statement, we refer to such information as “Personal Information.” Examples of Personal Information include name, email address, and mobile phone number, and credit card or other billing information. Personal Information also includes other information, such as date of birth, geographic area, or preferences, when any such information is linked to information that identifies a specific individual. You may provide us with Personal Information in various ways on the Service. For example, you provide us with Personal Information when you register for an account, use the Service, make a purchase on the Service, or send us customer service-related requests.
...
Please contact us with any questions or comments about this Policy, your Personal Information, our use and disclosure practices, or your consent choices by email at contact@snowledge.co.

Snowledge Corporation
