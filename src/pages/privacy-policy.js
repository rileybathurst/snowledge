...
const DownloadPage = () => (
  <Layout>
    ...
    <p>Last Updated: November 20, 2015

    <p>Welcome, and thank you for your interest in Snowledge Corporation (“Snowledge”, “We,” or “Us”) and our Web site at www.snowledge.co (the “Site”), as well as all related web sites, networks, applications, and other services provided by us and on which a link to this Privacy Policy (this “Policy”) is displayed (collectively, together with the Site, our “Service”).</p>
    ...
    <p>This Policy is incorporated into and is subject to the Snowledge Terms of Use (available at snowledge.co/terms). Capitalized terms used but not defined in this Policy have the meaning given to them in the Snowledge Terms of Use.</p>

    <p>The information we collect on the Service:</p>
...
<p>We use the information that we collect on the Service to understand and analyze the usage trends and preferences of our users, to improve the Service, and to develop new products, services, feature, and functionality.</p>
...
<p>Any information that you voluntarily choose to include in a publicly accessible area of the Service, will be available to anyone who has access to that content, including other users.</p>
...
<p>Information about our users, including Personal Information, may be disclosed and otherwise transferred to an acquirer, or successor or assignee as part of any merger, acquisition, debt financing, sale of assets, or similar transaction, as well as in the event of an insolvency, bankruptcy, or receivership in which information is transferred to one or more third parties as one of our business assets.
Your Choices</p>

<p>You may, of course, decline to share certain Personal Information with us, in which case we may not be able to provide to you some of the features and functionality of the Service. You may update, correct, or delete your account information and preferences at any time by accessing your account preferences page on the Service. If you wish to access or amend any other Personal Information we hold about you, you may contact us at contact@snowledge.co. Please note that while any changes you make will be reflected in active user databases instantly or within a reasonable period of time, we may retain all information you submit for backups, archiving, prevention of fraud and abuse, analytics, satisfaction of legal obligations, or where we otherwise reasonably believe that we have a legitimate reason to do so.</p>
...
<p>Please contact us with any questions or comments about this Policy, your Personal Information, our use and disclosure practices, or your consent choices by email at contact@snowledge.co.</p>

<p>Snowledge Corporation
